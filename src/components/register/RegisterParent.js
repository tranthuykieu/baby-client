...
class RegisterParent extends Component {
  ...
  _handleChange = (e) => {
    ...
    if (e.target.id == 0) {
      preParent.phoneNumber = e.target.value;
    }
    ...
    console.log(
      "Parent: " + preParent.phoneNumber + " target value: " + e.target.value
    );

    this.setState(preParent);
  };
        ...
        <FormGroup>
          ...
          <Form>
            ...
            <Nav>
              ...
              <Input onChange={this._handleChange} type="text" id="9" />
            </Nav>
